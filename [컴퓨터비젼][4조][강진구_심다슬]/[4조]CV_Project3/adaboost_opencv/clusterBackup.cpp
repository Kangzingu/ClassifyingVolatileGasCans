...
//void KMeansClustering(int *x, int *y, int k, int round, float& sse, int* labelResult, float centerImageX, float centerImageY, bool isSub);
...
//	//	KMeansClustering(pointX, pointY, i, 150, sse[i], labelResult, clusterImage);//값은 acc[1]부터 acc[kMeansIter-1]까지 총 19개의 점
//	//	if (sse[i] < accMin)
//	//		accMin = sse[i];
//	//	if (sse[i] > accMax)
//	//		accMax = sse[i];
...
//	////출력이란다
//	//float optimalAcc = 0;
//	//KMeansClustering(pointX, pointY, maxIdx, 150, optimalAcc, labelResult, clusterImage);//값은 acc[1]부터 acc[kMeansIter-1]까지 총 19개의 점
//
//	//for (int i = 0; i < scene.size(); i++) {
...
//	//	}
//	//}
//	//printf("labelresultsize: %d, keypointsize: %d", count, scene.size());
//	/////////////////////////////////////////////////////////////////////////////////////////////////////////
//	//binary로 변환
...
//	imread("E:/inputImage_grayscale/6.jpg").copyTo(img2);
//	imread("E:/inputImage_grayscale/6.jpg").copyTo(resultPoinnt);
//
...
//	///////////////////////////////////////////////////////////////////////////진구
//	Mat clusterImage;
//	imread("E:/inputImage_grayscale/6.jpg").copyTo(clusterImage);
//
//	int clusterK = 6;
...
//
//	imwrite("result9.bmp", resultPoinnt);
//	waitKey(0);
//
//	return EXIT_SUCCESS;
//}
