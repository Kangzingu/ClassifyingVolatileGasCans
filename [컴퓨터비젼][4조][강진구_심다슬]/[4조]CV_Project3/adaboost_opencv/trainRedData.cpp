...
//void KMeansClustering(int *x, int *y, int k, int round, float& sse, int* labelResult, float centerImageX, float centerImageY, bool isSub, bool isLast);
...
//	/////////////////////////////////////////////////////////////////////////////////////////////////////////
//	//Mat clusterImage;
//	//imread("E:/inputImage_grayscale/7.jpg").copyTo(clusterImage);
//
...
//	//	KMeansClustering(pointX, pointY, i, 150, sse[i], labelResult, (float)(clusterImage.cols / 2), (float)(clusterImage.rows / 2), false, false);//값은 acc[1]부터 acc[kMeansIter-1]까지 총 19개의 점
//	//	if (sse[i] < accMin)
//	//		accMin = sse[i];
//	//	if (sse[i] > accMax)
//	//		accMax = sse[i];
...
//	////출력이란다
//	//float optimalAcc = 0;
//	//KMeansClustering(pointX, pointY, maxIdx, 150, optimalAcc, labelResult, (float)(clusterImage.cols / 2), (float)(clusterImage.rows / 2), false, true);//값은 acc[1]부터 acc[kMeansIter-1]까지 총 19개의 점
//
//	//for (int i = 0; i < scene.size(); i++) {
...
//	imread("E:/inputImage_grayscale/5.jpg")
//		.copyTo(img2);
//	imread("E:/inputImage_grayscale/5.jpg").copyTo(resultPoinnt);
//
...
//	///////////////////////////////////////////////////////////////////////////진구
//	Mat clusterImage;
//	imread("E:/inputImage_grayscale/5.jpg").copyTo(clusterImage);
//	
//	int clusterK = 6;
...
//	float accMax = 0;
//	for (int i = 1; i < kMeansIter; i++) {
//		KMeansClustering(pointX, pointY, i, 150, sse[i], labelResult, (float)(clusterImage.rows/2), (float)(clusterImage.cols/2),false,false);//값은 acc[1]부터 acc[kMeansIter-1]까지 총 19개의 점
//		if (sse[i] < accMin)
//			accMin = sse[i];
//		if (sse[i] > accMax)
//			accMax = sse[i];
...
//	//출력이란다
//	float optimalAcc = 0;
//	KMeansClustering(pointX, pointY, maxIdx, 150, optimalAcc, labelResult, (float)(clusterImage.rows / 2), (float)(clusterImage.cols / 2), false,true);//값은 acc[1]부터 acc[kMeansIter-1]까지 총 19개의 점
//
//	for (int i = 0; i < keypoints2.size(); i++) {
...
//
//	imwrite("result17.bmp", resultPoinnt);
//	waitKey(0);
//
//	return EXIT_SUCCESS;
//}
